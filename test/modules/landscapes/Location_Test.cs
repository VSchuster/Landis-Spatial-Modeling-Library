...
namespace Wisc.Flel.Test.GeospatialModeling.Landscapes
{
    ...
    public class Location_Test
    {
        ...
        [Test]
        public void ConversionToCellLoc()
        {
            //  Implicit conversion during assignment
            CellLocation cellLocation = loc_1234_987;
            CheckCellLocation(cellLocation, loc_1234_987.Row, loc_1234_987.Column);

            //  Implicit conversion during method call
            CheckCellLocation(loc_1234_987, loc_1234_987.Row, loc_1234_987.Column);
        }


        //---------------------------------------------------------------------

        private void CheckCellLocation(CellLocation cellLocation,
                                       int          expectedRow,
                                       int          expectedColumn)
        {
            Assert.AreEqual(expectedRow,    cellLocation.Row);
            Assert.AreEqual(expectedColumn, cellLocation.Column);
        }

        //---------------------------------------------------------------------

        [Test]
        public void ConversionFromCellLoc()
        {
            //  Implicit conversion during assignment
            CellLocation cellLocation = new CellLocation(987654321, 707);
            Location location = cellLocation;
            CheckLocation(location, cellLocation.Row, cellLocation.Column);

            //  Implicit conversion during method call
            CheckLocation(cellLocation, cellLocation.Row, cellLocation.Column);
        }
        ...
        private void CheckLocation(Location location,
                                   ...
                                   int      expectedColumn)
        {
            Assert.AreEqual(expectedRow,    location.Row);
